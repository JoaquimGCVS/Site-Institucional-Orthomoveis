    ...
    images: [
      {
        ...
        desc1: "O Colchonete Orthocrin é indicado para diversos tipos de treino, como academia, yoga e exercícios em casa. É fabricado com matéria-prima de alta qualidade, revestido em napa impermeável, resistente e fácil de limpar.",
        desc2: "Entre seus benefícios, destaca-se o uso multiuso para ginástica, yoga e outros treinos, além de contar com um design clássico que combina com qualquer ambiente. Suas especificações incluem densidade D28, cor preta, altura de 4 cm e medidas de 50x100 cm, com garantia de 12 meses.",
        desc3: "O produto possui certificação Pró Espuma, que assegura qualidade superior e durabilidade. A prática de atividades físicas com o colchonete auxilia na manutenção de uma vida saudável, promovendo a liberação de endorfina e a sensação de bem-estar."
      },
      {
        src: colchonete2,
        ...
        desc1: "O Colchão Anti Stress tipo “casca de ovo” auxilia no alívio da pressão, melhora a circulação sanguínea e proporciona maior conforto. É indicado especialmente para pessoas acamadas com mobilidade reduzida devido a doenças, acidentes ou recuperação.",
      ...
      },
      {
        ...
        desc1: "O Colchonete Orthocrin é indicado para treinos na academia, yoga, camping e viagens. É produzido com espuma certificada D20 e tecido multiflex preto, passando por rigorosos testes de qualidade.",
    ...
    images: [
      {
        ...
        desc1: "O Travesseiro Apoio Antirrefluxo Adulto Orthocrin foi desenvolvido para aliviar sintomas e desconfortos do refluxo. Seu formato em rampa eleva a parte superior do corpo, mantendo a cabeça mais alta e reduzindo a incidência de refluxo durante o sono.",
      ...
      },
      {
        ...
        desc1: "O Travesseiro Antirrefluxo Comfort Baby foi criado para proporcionar sono seguro e confortável, ajudando a prevenir o refluxo gastroesofágico em bebês. Sua inclinação de aproximadamente 10 graus reduz o risco de desconforto, garantindo noites mais tranquilas.",
    ...
    images: [
      {
        ...
        desc1: "O Encosto Triangular MultiRelax Basic Orthocrin oferece suporte firme para relaxamento, leitura ou trabalho. Seu design ergonômico auxilia na postura correta, proporcionando conforto para lombar, coluna e pescoço.",
      ...
      },
      {
        ...
        desc1: "O Travesseiro Multirelax Visco Orthocrin é ideal para aliviar dores nas costas e pernas, especialmente para quem sofre com má circulação. Feito com espuma viscoelástica de alta densidade, seu formato triangular ergonômico oferece suporte para lombar, coluna e pescoço, aliviando pontos de pressão.",
    ...
    images: [
      {
        ...
        srcModal: T9,
        desc1: "A Almofada de Pescoço Orthotrip Orthocrin é feita com espuma viscoelástica e design anatômico, proporcionando suporte ergonômico e alívio dos pontos de pressão na cabeça, pescoço e ombros. Seu formato em U mantém a postura correta e reduz a tensão muscular durante o sono.",
        desc2: "Revestida com malha de alta gramatura, oferece toque macio e aconchegante, sendo ideal para uso em aviões, carros, trens e ônibus. Compacta e portátil, mede 30x30x14 cm e é fácil de transportar em bolsas de viagem.",
        desc3: "O tecido de alta qualidade é fácil de limpar, enquanto a espuma mantém sua forma ao longo do tempo. A almofada garante conforto e bem-estar em trajetos curtos ou longos, ajudando a chegar ao destino mais descansado."
      }
    ]
  },
  {
    ...
    images: [
      {
        ...
        srcModal: protetor,
        desc1: "O Protetor de Colchão Impermeável Flor de Algodão Fibrasca é feito em tecido matelassado com três camadas: malha dupla com face superior em algodão para maciez e inferior em poliéster para resistência, manta de fibra siliconada para conforto extra e revestimento impermeável que impede a passagem de líquidos.",
        desc2: "Possui slip com elastano que abraça toda a lateral, garantindo ótima fixação em colchões de até 40 cm de altura, disponível nos tamanhos solteiro, casal, queen e king. A malha jacquard exclusiva Flor de Algodão proporciona toque macio e agradável.",
        desc3: "Conta com nanotecnologia que protege contra fungos, ácaros e bactérias. Assim, une proteção, conforto e durabilidade em um único produto."
      }
    ]
  }
];
