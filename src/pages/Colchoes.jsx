...
const categorias = [
  ...
  descCategoria: "",
    ...
    images: [
      ...
      { src: p2, alt: "Privillége Gel", title: "Privillége Gel", desc: "Dupla camada de conforto com espuma hipersoft e toque macio, perfeita para noites de sono renovador.", srcModal: E1, desc1: "O colchão Privillége Gel possui dupla camada de conforto que combina frescor, suporte e elasticidade, proporcionando um sono renovador. Sua malha de alta gramatura, feita no Brasil com tecnologia belga e fios nobres de viscose pura, oferece toque suave, resistência e qualidade.", desc2: "A estrutura conta com espuma hipersoft de altíssima resiliência. Os cristais de gel exercem duas funções, acomodam o corpo em uma posição ideal e confortável e impedem que o calor excessivo se propague pelo colchão durante a noite, resultando em uma noite tranquila e um sono profundo.", desc3: "Com altura de 36 cm, entrega suporte ideal e sensação de aconchego para noites tranquilas e revigorantes." },
  ...
  descCategoria: "",
    ...
    color: "#80002D",
    images: [
      { src: s1, alt: "Primor", title: "Primor", desc: "Conforto intermediário com molas ensacadas Comfort Core prata e camadas de espuma. Tecido plano e altura de 26 cm com excelente custo-benefício.", srcModal: S1, desc1: "Conforto intermediário que equilibra firmeza e suavidade, oferecendo estabilidade para a coluna e excelente custo-benefício. Espuma certificada com mix de espumas especiais garante durabilidade e compromisso sustentável.", desc2: "Estrutura de molas ensacadas Prata da Leggett & Platt com suporte personalizado e independência de movimento, bordas laterais em espuma, tecido Jacquard Bamboo suave ao toque e design one face. Certificações asseguram qualidade e segurança.", desc3: "Altura de 26 cm, suporta até 120 kg por pessoa." },
      { src: s2, alt: "Selene", title: "Selene", desc: "Molas Superlastic com espumas adaptáveis, tecido Jacquard bamboo e altura de 24 cm. Conforto intermediário com sustentação progressiva.", srcModal: S2, desc1: "Conforto intermediário que combina firmeza e suavidade, oferecendo suporte ideal e momentos relaxantes após um dia cansativo. Desenvolvido para garantir qualidade, durabilidade e excelente custo-benefício.", desc2: "Camada de conforto com mix de espumas certificadas, tecido Jacquard Bamboo suave ao toque, estrutura de molas Superlastic para suporte resiliente e liberdade de movimento, bordas laterais em espuma e design one face. Certificações asseguram padrão de segurança e desempenho.", desc3: "Altura de 24 cm, suporta até 120 kg por pessoa." },
    ]
  },
  {
  ...
  descCategoria: "",
    ...
    color: "#80002D",
    images: [
      { src: b1, alt: "Basic Pillow Top", title: "Real", desc: "Pillow top com conforto extra e molas ensacadas, garantindo suporte e maciez no descanso diário.", srcModal: B1, desc1: "Conforto intermediário que equilibra firmeza e suavidade, com combinação de espumas convencionais e pillow top para maciez extra e acolhimento luxuoso. Desenvolvido para oferecer suporte ergonômico e noites de sono revigorantes.", desc2: "Estrutura de molas ensacadas Comfort Core Prata com independência de movimento, bordas laterais em espuma para estabilidade, malha soft volumosa para conforto térmico e design sofisticado. Certificações garantem qualidade e segurança.", desc3: "Altura de 30 cm, suporta até 120 kg por pessoa" },
      { src: b2, alt: "Basic Real Black", title: "Real Black", desc: "Versão elegante com pillow top e molas ensacadas, oferecendo maciez e sustentação.", srcModal: B2, desc1: "Conforto intermediário com equilíbrio entre firmeza e suavidade, combinando espumas convencionais e pillow top para maciez extra e acolhimento luxuoso. Desenvolvido para suporte ergonômico e noites de sono confortáveis.", desc2: "Estrutura de molas ensacadas Comfort Core Prata com independência de movimento, bordas laterais em espuma para estabilidade, malha soft volumosa que oferece conforto térmico e design moderno em preto com detalhes azuis. Certificações garantem qualidade e segurança.", desc3: "Altura de 30 cm, suporta até 120 kg por pessoa." },
    ...
    images: [
      {
        ...
        desc2: "Tecido Jacquard Bamboo, suave, ventilado e com propriedades antialérgicas e antiácaros. Estrutura em espuma D18 certificada, ideal para recém-nascidos e crianças, com garantia de qualidade Pró-Espuma aprovada pelo INER.",
      ...
      },
      {
        ...
        alt: "Junior Luxo",
        title: "Junior Luxo",
        desc: "Colchão de berço tradicional em espuma, dupla face com um lado liso. Conforto firme e durável para o bebê.",
        srcModal: K2,
        desc1: "Conforto adaptável para bebês e crianças. Seu design moderno valoriza o ambiente, proporcionando noites de sono tranquilas para toda a família.",
        ...
        desc3: "Altura do colchão é de 10 cm com dupla face para maior durabilidade. Disponível nos tamanhos 60x130 cm, 70x130 cm e 70x150 cm."
      }
    ]
  },
  {
    ...
    images: [
      {
        ...
        desc3: "Disponível em dois tamanhos: grande (80x100 cm) e pequena (60x80 cm)."
      },
      {
        src: pets1,
