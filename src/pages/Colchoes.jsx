...
const categorias = [
  ...
  },
  {
    ...
    images: [
      ...
      { src: c6, alt: "Splendor", title: "Splendor", desc: "Espuma convencional e molas ensacadas com tecnologia Purotex®, para conforto firme e frescor natural prolongado.", srcModal: CC6, desc1: "Tecnologia Purotex® com probióticos naturais que purificam o ambiente de sono continuamente.", desc2: "Molas ensacadas de precisão combinadas com espuma convencional de alta densidade D28.", desc3: "Sistema de ventilação natural que reduz umidade e mantém frescor por até 8 horas. Conforto firme recomendado para pessoas que preferem maior sustentação." },
      { src: c7, alt: "Royal Saúde Anatomic Power", title: "Royal Saúde Anatomic Power", desc: "Molas ensacadas e espuma de alta densidade que proporcionam firmeza, alinhamento corporal e noites sem desconforto.", srcModal: CC7, desc1: "Design anatômico com 7 zonas de conforto diferenciado para cabeça, ombros, lombar, quadris e pernas.", desc2: "Molas ensacadas de alta resistência combinadas com espuma D33 certificada.", desc3: "Sistema que mantém alinhamento natural da coluna em qualquer posição de sono. Indicado especialmente para pessoas com problemas posturais ou dores nas costas." },
    ]
  },
  {
